...
export function get_movie_query(query : MovieSearchQueryParams, sep = [" ", ".", "", "_"]) {
    let queries: string[] = [];
    let possible_terms = [];
...
export function  get_file_query(filename: string, sep = [" ", ".", "", "_"]) {
    let queries: string[] = [];
    let possible_terms = [];
    ...
    // get_file_query(filename: string){
    //     let queries: string[] = [];
    //     s
    // }
...
// console.log(get_file_query("wanted test"))